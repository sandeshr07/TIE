            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                      ...
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-leaf" aria-hidden="true"></i><span class="hide-menu">Clothe</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_types.php">All Clothes</a></li>
								<li><a href="add_types.php">Add Clothe</a></li>
