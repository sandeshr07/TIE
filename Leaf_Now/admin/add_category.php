            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                     ...
                     <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-leaf" aria-hidden="true"></i><span class="hide-menu">Types</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_types.php">All Types</a></li>
								<li><a href="add_types.php">Add Types</a></li>
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Stores Category</h4>
                            </div>
                            <div class="card-body">
